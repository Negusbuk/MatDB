...
BoilingPointProperty::BoilingPointProperty(ParameterModel* model, int id) :
    Property(id)
{
    setName("Boiling Point");
    setDisplayName(QObject::tr("Boiling Point"));
    setCategory(FluidProperty);
    setType(BoilingPoint);
    setBehavior(Isotropic);
    Parameter *par = model->getParameter("Boiling Point");
    addParameter(par->clone());
}

BoilingPointProperty::BoilingPointProperty(const BoilingPointProperty& property) :
...
Property* BoilingPointProperty::clone(ParameterModel* model)
{
...
//</PropertyData>
void BoilingPointProperty::apply(PropertyData& data,
...
void BoilingPointProperty::writeXML(QXmlStreamWriter& stream)
{
...
void BoilingPointProperty::writeXMLData(QXmlStreamWriter& stream)
{
    NQLog("BoilingPoint", NQLog::Spam) << "  XML write data for property " << getName()
